...
import com.example.wangjunchao.chauffeurdemo.library.BaseDialog;
import com.example.wangjunchao.chauffeurdemo.view.adapter.GridImageAdapter;
...
public class TackGoodsActivity extends BaseActivity{
    ...
    protected int getLayoutId() {
        return R.layout.activity_tack_goods;
    }
        ...
        dialog = builder.setViewId(R.layout.photo_choose_dialog)
                ...
                .addViewOnClickListener(R.id.but_choose_one, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        PictureSelector.create(TackGoodsActivity.this)
